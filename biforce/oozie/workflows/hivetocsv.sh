#!/bin/bash
hive -e "use biforce_staging"

hive -e "CREATE TABLE SPARK_DATA (ROW_NUM INT, TEST_TYPE INT, RAW_SCORE DECIMAL(3, 0), SCORE DECIMAL(5, 2), TEST_PERIOD INT, TEST_CATEGORY INT, TRAINER_ID INT, BATCH_ID INT, GROUP_TYPE STRING, BATTERY_ID INT, BATTERY_STATUS INT)"

hive -e "INSERT OVERWRITE TABLE SPARK_DATA
...
select * from biforce_staging.spark_data"
cat $1/* > $2/spark_data.csv
