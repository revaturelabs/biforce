...
/**
 * Takes an input csv, and split count and returns percentiles which are equi-distant in the dataset
 * for test types 0-3 inclusive.
 * @author Tim Law
 * @author Mason Wegert
 *
 */
public class PartitionFinder {
	/**
	 * splits up the csv by the percentiles which are equi-distant for the spitCount.
	 * @param csv - input csv
