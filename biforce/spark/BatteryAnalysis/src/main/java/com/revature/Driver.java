...
public class Driver {
	...
	/**
	 * Prints the equation for calculating the probability of failure based on the
	 * modelParams. Prints to the console and accuracyWriter for each of the 3 exam
	 * types (one for verbal, exam, project scores). Test type 4 (other) has a low
	 * correlation (0.2) and negatively effects the results.
	 * 
	 * @param modelParams
	 */
